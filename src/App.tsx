    ...
    <div>
        ...
        <main>
          ...
          <section className="bg-primaryDarkViolet">
            <div className="bg-[url('../src/assets/images/bg-boost-desktop.svg')] bg-no-repeat bg-cover bg-center">
        ...
        <footer className="bg-neutralVeryDarkViolet bottom-0 font-semibold">
          <div className="max-w-[1000px] mx-auto py-20 flex justify-between h-full">
            ...
            <div className="flex justify-between">
              <div className="mx-10">
                ...
                <div className="text-xs mb-3 text-neutralGray hover:text-primaryCyan hover:cursor-pointer">Link Shortening</div>
                <div className="text-xs mb-3 text-neutralGray hover:text-primaryCyan hover:cursor-pointer">Branded Links</div>
                <div className="text-xs mb-3 text-neutralGray hover:text-primaryCyan hover:cursor-pointer">Analytics</div>
              </div>
              <div className="mx-10">
                <div className="text-sm font-black pb-4 text-white">Resources</div>
                <div className="text-xs mb-3 text-neutralGray hover:text-primaryCyan hover:cursor-pointer">Blog</div>
                <div className="text-xs mb-3 text-neutralGray hover:text-primaryCyan hover:cursor-pointer">Developers</div>
                <div className="text-xs mb-3 text-neutralGray hover:text-primaryCyan hover:cursor-pointer">Support</div>
              </div>
              <div className="mx-10">
                <div className="text-sm font-black pb-4 text-white">Company</div>
                <div className="text-xs mb-3 text-neutralGray hover:text-primaryCyan hover:cursor-pointer">About</div>
                <div className="text-xs mb-3 text-neutralGray hover:text-primaryCyan hover:cursor-pointer">Our Team</div>
                <div className="text-xs mb-3 text-neutralGray hover:text-primaryCyan hover:cursor-pointer">Careers</div>
                <div className="text-xs mb-3 text-neutralGray hover:text-primaryCyan hover:cursor-pointer">Contact</div>
              </div>
